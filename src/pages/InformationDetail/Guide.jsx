            ...
            <Container>
                <div>
                    ...
                    <div className='flex mt-4'>
                        <div className='pr-3'>
                            <h1 class="text-xl font-bold">Với khách hàng mua online: </h1>
                            <div>
                                <p className='mt-3'>
                                ...
                                <ul class="marker:text-green-400 list-disc pl-5 space-y-3 mt-3">
                                    <li>
                        ...
                        <div className='pl-3'>
                            <h1 class="text-xl font-bold">Với khách hàng mua trực tiếp: </h1>
                            <p className='mt-3'>
